...
species = {
    "athene_brama": "Athene brama",
    "copsychus_fulicatus": "Copsychus fulicatus",
    "psilopogon_haemacephalus": "Psilopogon haemacephalus"
}
...
def get_clean_ids(sci_name):
    ...
    return list(dict.fromkeys(ids))[:10]  # Get top 10 unique IDs
